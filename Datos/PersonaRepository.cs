...
namespace Datos
{
    public class PersonaRepository
    {
        ...
        public void Guardar(Persona persona)
        {
            ...
            {
                command.CommandText = @"Insert Into Persona (Identificacion,Nombres,Apellidos,Edad,Sexo,Departamento,Ciudad,ValorApoyo,Modalidad,Fecha) 
                                        values (@Identificacion,@Nombres,@Apellidos,@Edad,@Sexo,@Departamento,@Ciudad,@ValorApoyo,@Modalidad,@Fecha)";
